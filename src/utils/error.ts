export const getPersianErrorMessage = (status: number): string => {
  const messages: Record<number, string> = {
    100: "در حال ادامه ارتباط با سرور...",
    101: "در حال تغییر پروتکل ارتباطی...",
    102: "در حال پردازش درخواست...",
    103: "اطلاعات اولیه دریافت شد...",

    200: "درخواست موفق بود.",
    201: "داده‌ها با موفقیت ایجاد شدند.",
    202: "درخواست پذیرفته شده است.",
    203: "اطلاعات غیر معتبر دریافت شد.",
    204: "هیچ محتوایی موجود نیست.",
    205: "بازنشانی محتوا لازم است.",
    206: "پاسخ جزئی دریافت شد.",

    300: "چند گزینه برای پاسخ وجود دارد.",
    301: "آدرس تغییر کرده است (انتقال دائمی).",
    302: "موقتا به آدرس دیگری هدایت شده است.",
    303: "مشاهده در مکان دیگر.",
    304: "محتوا تغییری نکرده است.",
    305: "دسترسی از طریق پراکسی مورد نیاز است.",
    307: "هدایت موقت به URL جدید.",
    308: "هدایت دائمی به URL جدید.",
    ...
    406: "محتوا با فرمت مورد نیاز مطابقت ندارد.",
    407: "احراز هویت از طریق پراکسی لازم است.",
    408: "درخواست بیش از حد زمان برد.",
    409: "تعارض در درخواست وجود دارد.",
    410: "منبع مورد نظر حذف شده است.",
    411: "طول درخواست مشخص نیست.",
    412: "پیش‌شرط درخواست برآورده نشد.",
    413: "حجم درخواست بیش از حد مجاز است.",
    414: "URL بیش از حد طولانی است.",
    415: "فرمت رسانه‌ای پشتیبانی نمی‌شود.",
    416: "محدوده درخواستی غیر معتبر است.",
    417: "انتظارات درخواست برآورده نشد.",
    418: "من قوری هستم ☕️",
    422: "داده‌های ارسال شده نامعتبر هستند.",
    425: "درخواست زود ارسال شده است.",
    426: "نیاز به ارتقاء پروتکل وجود دارد.",
    429: "تعداد درخواست‌ها بیش از حد مجاز است.",

    500: "خطای داخلی سرور.",
    501: "امکان انجام درخواست وجود ندارد.",
    502: "خطا در دروازه ورودی.",
    503: "سرور موقتا در دسترس نیست.",
    504: "پاسخ‌دهی سرور با تأخیر مواجه شد.",
    505: "نسخه HTTP پشتیبانی نمی‌شود.",
    507: "فضای ذخیره‌سازی کافی نیست.",
    511: "احراز هویت شبکه مورد نیاز است.",
  };

  return messages[status] || "خطای ناشناخته‌ای رخ داده است.";
};

export const translateSupabaseAuthError = (error: string): string => {
